...
const DRESSES = [
  ...
  { id: 3, name: 'فستان حرير ناعم بفتحة جانبية', price: 500, currency: 'EGP', image: '/dress-3.jpg' },
  { id: 4, name: 'فستان شيفون مرصع بالكريستال', price: 500, currency: 'EGP', image: '/dress-4.jpg' },
  { id: 5, name: 'فستان كلاسيكي بأكمام دانتيل', price: 500, currency: 'EGP', image: '/dress-5.jpg' },
  { id: 6, name: 'فستان منفوش بتطريز ذهبي', price: 500, currency: 'EGP', image: '/dress-6.jpg' },
  { id: 7, name: 'فستان ساتان لامع بكتف واحد', price: 500, currency: 'EGP', image: '/dress-7.jpg' },
  { id: 8, name: 'فستان سهرة بتصميم درابيه', price: 500, currency: 'EGP', image: '/dress-8.jpg' },
  { id: 9, name: 'فستان تول مطرز بالورود', price: 500, currency: 'EGP', image: '/dress-9.jpg' },
  { id: 10, name: 'فستان بقصة أميرات ديزني', price: 500, currency: 'EGP', image: '/dress-10.jpg' },
  { id: 11, name: 'فستان سهرة أسود كلاسيكي', price: 500, currency: 'EGP', image: '/dress-11.jpg' },
  { id: 12, name: 'فستان مرصع بالترتر اللامع', price: 500, currency: 'EGP', image: '/dress-12.jpg' },
  { id: 13, name: 'فستان بأكمام منفوخة وتطريز', price: 500, currency: 'EGP', image: '/dress-13.jpg' },
  { id: 14, name: 'فستان سهرة عنابي فاخر', price: 500, currency: 'EGP', image: '/dress-14.jpg' },
  { id: 15, name: 'فستان بقصة مستقيمة وظهر مكشوف', price: 500, currency: 'EGP', image: '/dress-15.jpg' },
  { id: 16, name: 'فستان شيفون بكسرات ناعمة', price: 500, currency: 'EGP', image: '/dress-16.jpg' },
  { id: 17, name: 'فستان سهرة زمردي جذاب', price: 500, currency: 'EGP', image: '/dress-17.jpg' },
  { id: 18, name: 'فستان مطرز باللؤلؤ الفاخر', price: 500, currency: 'EGP', image: '/dress-18.jpg' },
  { id: 19, name: 'فستان كريب بتصميم عصري', price: 500, currency: 'EGP', image: '/dress-19.jpg' },
  { id: 20, name: 'فستان سهرة بياقة V عميقة', price: 500, currency: 'EGP', image: '/dress-20.jpg' },
  { id: 21, name: 'فستان دانتيل فرنسي راقي', price: 500, currency: 'EGP', image: '/dress-21.jpg' },
  { id: 22, name: 'فستان بأكمام طويلة وتطريز فضي', price: 500, currency: 'EGP', image: '/dress-22.jpg' },
  { id: 23, name: 'فستان سهرة نيود بتفاصيل لامعة', price: 500, currency: 'EGP', image: '/dress-23.jpg' },
  { id: 24, name: 'فستان بقصة الكورسيه الجذابة', price: 500, currency: 'EGP', image: '/dress-24.jpg' },
  { id: 25, name: 'فستان سهرة كحلي مرصع بالنجوم', price: 500, currency: 'EGP', image: '/dress-25.jpg' },
  { id: 26, name: 'فستان بتنورة متدرجة الطبقات', price: 500, currency: 'EGP', image: '/dress-26.jpg' },
  { id: 27, name: 'فستان سهرة بكتف مكشوف', price: 500, currency: 'EGP', image: '/dress-27.jpg' },
  { id: 28, name: 'فستان حريري بتصميم انسيابي', price: 500, currency: 'EGP', image: '/dress-28.jpg' },
  { id: 29, name: 'فستان سهرة فاخر بتطريز يدوي', price: 500, currency: 'EGP', image: '/dress-29.jpg' },
];
